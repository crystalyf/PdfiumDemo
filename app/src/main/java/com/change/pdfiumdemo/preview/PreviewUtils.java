package com.change.pdfiumdemo.preview;
...
public class PreviewUtils {
     ...
     * @param pageNum     pdf页码
     */
    void loadBitmapFromPdf(final Context context,
     ...
     * @param keyPage 页码
     */
    void cancelLoadBitmapFromPdf(String keyPage) {
    ...
    public static class ImageCache {
         ...
         * @return 图片
         */
        synchronized Bitmap getBitmapFromLruCache(String key) {
            if (lruCache != null) {
         ...
         * @param bitmap 图片
         */
        synchronized void addBitmapToLruCache(String key, Bitmap bitmap) {
